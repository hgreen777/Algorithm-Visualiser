...
framerate = 100                  # Advise < 1000 (unlikely pc will be quick enough). Try to match the framerate with the actual to make it more efficient like with games, capping the fps makes it smoother.
array_size = 1000             # Cannot be bigger then the useable X (advised size depends on sorting/searching algorithm used).
current_algorithm = quickSort      # Pick the current running algo.
